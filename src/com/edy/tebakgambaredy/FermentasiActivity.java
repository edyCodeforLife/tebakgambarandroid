package com.edy.tebakgambaredy;
...
public class FermentasiActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fermentasi);
    ...
    public void cekJawaban(View v){
		String  jawabanBenar = "FERMENTASI ANGGUR";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),IgabakarActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.fermentasi, menu);
		return true;
	}
